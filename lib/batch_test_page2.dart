...
/// Batch test page.
class BatchTestPage2 extends TestPage {
  /// Batch test page.
  BatchTestPage2() : super('Batch tests') {
    test('BatchQuery', () async {
      ...
      //   // ]
      //   // 
      //   [{'id': 1, 'name': 'item1'}, {'id': 2, 'name': 'item2'}, {'id': 3, 'name': 'item3'}, {'id': 4, 'name': 'item4'}, {'id': 5, 'name': 'item5'}, {'id': 6, 'name': 'item6'}], 
